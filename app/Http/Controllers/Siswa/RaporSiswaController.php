...
class RaporSiswaController extends Controller
{
    ...
    public function index()
    {
        ...
        $nilai_rapor = NilaiRapor::where('nis' , $mahasiswa->nim)
        ...
        return view('siswa.raporsiswa.index', [
    ...
    public function cariDataLapor(Request $request)
    {
        ...
        $nilai_rapor = NilaiRapor::where('nis' , $siswa->NIS)
        ->where('tahun_ajaran', $tahun_ajaran)
        ->where('semester', $semester)
        ->where('kelas_siswa', $kelas)
        ->get();

        $data_nilai_rapor = NilaiRapor::where('nis' , $siswa->NIS)
        ->where('tahun_ajaran', $tahun_ajaran)
        ->where('semester', $semester)
        ->where('kelas_siswa', $kelas)
        ->first();
    ...
    public function show($id)
    {
        ...
        return view('siswa.raporsiswa.show',compact(
          'nilai_rapor',
          'nilai_rapor_siswa',
          'grade_nilai'

...
class DataPegawaiController extends Controller
{
  ...
  {
    if (Gate::denies('manage-pegawai')) {
        abort(403, 'User does not have the right permissions.');
    }
    $data_guru = Guru::all();
    $data_pegawai = Pegawai::all();
    $mapel = MataPelajaran::all();
    return view('pegawai.datapegawai.index', ['data_guru' => $data_guru, 'data_pegawai' => $data_pegawai, 'mapel' => $mapel]);
  }

  public function uploaddatapegawaiakademik()
  {
    return view('pegawai.datapegawai.akademik.uploaddatapegawai');
  }

  public function uploaddatapegawainonakademik()
  {
    return view('pegawai.datapegawai.nonakademik.uploaddatapegawai');
  }
  ...
  public function create(Request $request)
  {
    ...
    return redirect()->route('pegawai.datapegawai.index')->with('sukses', 'Data Berhasil Ditambahkan');
  }
  ...
  public function show($id)
  {
    ...
    return view('pegawai/datapegawai/show')->with('pegawai', $datapegawai);
  }
  ...
  public function destroy($id)
  {
    ...
    return redirect()->route('pegawai.datapegawai.index')->with('sukses', 'Data Berhasil Dihapus');
  }

  public function hapusAkademik($id)
  {
    if (Gate::denies('delete-users')) {
      return redirect()->route('pegawai.datapegawai.index');
    }
  ...
  public function detailpegawaiakademik($id)
  {
    ...
    return view('pegawai.datapegawai.akademik.detailpegawaiakademik', [
      'guru' => $guru
    ]);
  }
  ...
  public function detailpegawainonakademik($id)
  {
    ...
    return view('pegawai.datapegawai.nonakademik.detailpegawainonakademik', [
      'pegawai' => $pegawai,
  ...
  public function updatePhotoAkademik(Request $request, $id)
  {
    ...
    if ($request->hasFile('photo_guru')) {
      ...
      if (File::exists($photoGuru)) {
        $photoGuru->move('pegawai/assets/images/users/guru/', $filename);
  ...
  public function updatePhotoNonAkademik(Request $request, $id)
  {
    ...
    if ($request->hasFile('photo_pegawai')) {
      ...
      if (File::exists($photoPegawai)) {
        $photoPegawai->move('pegawai/assets/images/users/pegawai/', $filename);

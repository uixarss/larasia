...
class EvaluasiSoalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pegawai.evaluasisoal.index', [
          'data_kuis' => $data_kuis,
          'data_uts' => $data_uts,
          'data_uas' => $data_uas
        ]);
    ...
    public function detailEvaluasi($id, $id_kelas)
    {
        ...
        // dd($data_jawaban);
        return view('pegawai.evaluasisoal.detailevaluasi', [
            'quiz' => $quiz,
    ...
    {
        $siswa = Mahasiswa::where('kelas_id', $kelas_id)->get('id');
        ...
        $jawaban_siswa = Option::join('answers', 'answers.option_id','=' ,'options.id')
                            ...
                            ->get()
                            ;
        // $jawaban_siswa = Answer::whereIn($siswa)->where('question_id', $question_id)->groupBy('option_id')->get();

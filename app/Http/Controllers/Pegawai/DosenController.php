...
class DosenController extends Controller
{
    ...
    {
        if (Gate::denies('manage-dosen')) {
          abort(403, 'User does not have the right permissions.');
        }
        $data_dosen = Dosen::all();

        return view('pegawai.datadosen.index' , [
          'data_dosen' => $data_dosen,
          ]);
    }

    public function create(Request $request){
      if (Gate::denies('create-dosen')) {
        abort(403, 'User does not have the right permissions.');
      }
        ...
        return redirect()->route('pegawai.dosen.index')->with('sukses','Data Berhasil Ditambahkan');
    }

    public function edit($id)
    {
        if (Gate::denies('edit-dosen')) {
          abort(403, 'User does not have the right permissions.');
        }
        $dosen = Dosen::find($id);
        ...
        return view('pegawai/datadosen/detail', ['data_kelas' => $data_kelas, 'dosen' => $dosen,
    ...
    public function updateDataKampus(Request $request, $id)
    {
      ...
      return redirect()->route('pegawai.dosen.edit', $dosen->id)->with('sukses','Data Berhasil Diupdate');
    ...
    public function destroy($id){
      ...
      return redirect()->route('pegawai.dosen.index')->with('sukses','Data Berhasil Dihapus');
    }

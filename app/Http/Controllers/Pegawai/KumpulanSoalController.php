...
class KumpulanSoalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pegawai.kumpulansoal.index', compact(
          'data_dosen',
        ));
    }
    ...
    public function list($id)
    {
      ...
      return view('pegawai.kumpulansoal.list', [
        'id_dosen' => $dosen->id,
    ...
    public function store(Request $request, $id, $matkul, $id_prodi, $semester, $tahun_ajaran)
    {
          ...
          return redirect()->route('pegawai.kumpulansoal.edit', $data_quiz->id )->with('sukses', 'Data Berhasil Ditambahkan');
    }
    ...
    public function show($id)
    {
          ...
          return view('pegawai.kumpulansoal.show',[
    ...
    public function edit($id)
    {
          ...
          return view('pegawai.kumpulansoal.edit', compact('data_quiz', 'data_question', 'data_option','pengampu'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/pegawai/kumpulansoal')->with('sukses','Data Berhasil Dihapus');
    }

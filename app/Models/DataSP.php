...
class DataSP extends Model
{
    //
    protected $table = 'data_sp';

    protected $fillable = [
        'id_fakultas', 'id_jurusan', 'id_prodi', 'mapel_id', 'tingkat_semester','status', 'id_tahun_ajaran', 'id_semester', 'id_mahasiswa'
    ];

  ...
  var calendar = new Calendar(calendarEl, {
    ...
    drop: function(element) {
      ...
      if (document.getElementById('drop-remove').checked) {
        ...
        sendEvent(routeEvents('routeDeleteListRemainder'), Event);
      }
      ...
      sendEvent(routeEvents('routeStoreEvents'), Event);
    ...
    eventClick: function(element) {
        ...
        $("#modalCalendar #titleModal").text('Edit Remainder Kalender Akademik');
    ...
    select: function(element) {
      ...
      resetForm("#formEvent");
      $("#modalCalendar").modal('show');
      $("#modalCalendar #titleModal").text('Tambah Remainder Kalender Akademik');

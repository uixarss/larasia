...
@section('title-page')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('admin.agendaguru.index') }}" class="text-muted text-hover-primary">Pilih Tahun Ajaran & Semester</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-400 w-5px h-2px"></span>
        </li>
    ...
    <div class="card card-px-0 bg-opacity-0">
        <div class="card-header border-0 pb-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-2x mb-1">Data Program Studi</span>
            </h3>
            ...
            <table id="table_data"
                ...
                <tbody class="fs-6 fw-semibold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="{{route('admin.agendaguru.detail', [ 'id_tahun_ajaran' => $tahun_ajaran->id ,'id_semester' => $semester->id, 'id_prodi' => $prodi->id_prodi ])}}" type="button" class="btn btn-sm btn-primary">Lihat Daftar Dosen</a>
                        </td>
                    </tr>

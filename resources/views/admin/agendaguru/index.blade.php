...
@section('title-page')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <li class="breadcrumb-item text-muted">Agenda Pelajaran</li>
    </ul>
@endsection
    ...
    <div class="card card-px-0 bg-opacity-0">
        <div class="card-header border-0 pb-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-2x mb-1">Data Agenda Pelajaran</span>
            </h3>
                    ...
                    @foreach ($data_tahun_ajaran as $no => $tahun_ajaran)
                        @foreach ($data_semester as $semester)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('admin.agendaguru.prodi', ['id_tahun_ajaran' => $tahun_ajaran->id, 'id_semester' => $semester->id]) }}"
                                        type="button" class="btn btn-sm btn-primary">Detail</a>
                                </td>
                            </tr>
                        @endforeach
                    @endforeach

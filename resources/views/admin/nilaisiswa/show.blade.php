              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="panel-subtitle">
                      <p>Pilih Mata Pelajaran untuk melihat nilai di pelajaran yang lain :</p>
                  </div>
                </div>
              </div>
              <div class="row push-up-20">
                <label class="col-md-2 control-label">Pilih Mata Pelajaran</label>

                <div class="col-md-7">
                  <form action="{{route('admin.nilaisiswa.show', $data_kelas->id)}}" method="get">
                    {{csrf_field()}}
                    @method('put')

        ...
        <div class="panel panel-deafult">
          <div class="panel-heading push-down-10">
            <div class="col-md-12">
              ...
              <form action="{{route('admin.raporsiswa.carilapor')}}" method="post">
              {{csrf_field()}}


              <div class="form-group">
                <div class="col-md-3">
                  <select name="tahun_ajaran" class="form-control select" data-live-search="true" required>
              ...
              <div class="form-group">
                <div class="col-md-3">
                  <select name="semester" class="form-control select" data-live-search="true" required>
              ...
              <div class="form-group">
                <div class="col-md-3">
                  <select name="kelas" class="form-control select" data-live-search="true" required>
              ...
              <table class="table datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="{{route('admin.raporsiswa.show', $rapor->id)}}" type="button" class="btn btn-success">Lihat Nilai Rapor</a></td>
                    </tr>
                    @endforeach
                  </tbody>
              </table>

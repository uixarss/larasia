...
<ul class="breadcrumb">
    ...
    <li><a href="{{ route('admin.evaluasisoal.index') }}">Evaluasi Soal</a></li>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <h3 class="panel-title pull-right"> Dosen : {{$quiz->dosen->nama_dosen ?? ''}}</h3>
                        <hr>
...
<script>
    $(function() {
        ...
        $(".baris-footer .data-jawaban").on("click", function() {
            ...
            var url = '{{route("admin.evaluasi.soal",[":question_id",":kelas_id"])}}';

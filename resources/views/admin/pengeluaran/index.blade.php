                ...
                <div class="tab-pane fade show active" id="data" role="tabpanel">
                    <div class="d-flex flex-wrap flex-stack mb-5">
                        ...
                        <div class="d-flex my-2">
                            <a href="{{route('admin.pengeluaran.create')}}" class="btn btn-primary fw-bolder">Tambah</a>
                        </div>
                    </div>
                    <table id="table_data"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{route('admin.pengeluaran.edit',[$bill])}}" class="btn btn-sm btn-warning">Edit</a>
                                </td>
                ...
                <div class="tab-pane fade" id="rekap" role="tabpanel">
                    <div class="d-flex flex-wrap flex-stack mb-5">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="{{ route('admin.pengeluaran.rekap', ['start' => $start ?? '', 'end' => $end ?? '']) }}" class="btn btn-sm btn-success btn-icon"><span class="fa fa-cloud-download"></span></a>
                            <div class="bullet bg-secondary h-35px w-1px mx-5"></div>
                        @endif
                            <form action="{{ route('admin.pengeluaran.cari.rekap') }}" method="POST" class="d-flex my-2">
                                @csrf
                                <div class="row g-3">
                                    <div class="col-auto">

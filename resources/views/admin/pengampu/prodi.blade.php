            ...
            <table id="table_data" class="table align-middle table-rounded border table-row-bordered table-row-gray-100 bg-white gy-4 gs-9">
                ...
                <tbody class="fs-6 fw-semibold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="{{route('admin.get.pengampu.detail', [ 'id_tahun_ajaran' => $tahun_ajaran->id ,'id_semester' => $semester->id, 'id_prodi' => $prodi->id_prodi ])}}" type="button" class="btn btn-sm btn-primary">Lihat Daftar Dosen</a>
                        </td>
                    </tr>

...
@section('content')
                ...
                <tbody>
                    ...
                    @foreach ($fakultas as $fakultas)
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.fakultas.visi.index', $fakultas->id) }}"
                                    class="btn btn-sm btn-info">Visi
                                    & Misi</a>
                                <a class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#editFakultas{{ $fakultas->id }}">Edit</a>

                                <a href="{{ route('admin.fakultas.destroy', $fakultas->id) }}" class="btn btn-sm btn-danger"
                                    onclick="return confirm('Yakin Mau di Hapus ?')">Hapus</a>
                            </td>
                        </tr>
                        <!-- Modal edit prodi-->
                        <div class="modal fade" id="editFakultas{{ $fakultas->id }}" tabindex="-1">
    ...
    <div class="modal fade" tabindex="-1" id="tambah">
        <div class="modal-dialog">
            <form class="modal-content" action="{{ route('admin.fakultas.create') }}" method="post">
                <div class="modal-header">

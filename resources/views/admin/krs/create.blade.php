...
<ul class="breadcrumb">
    ...
    <li class="active">Buat Kartu Rencana Studi</li>
</ul>
<!-- END BREADCRUMB -->

<!-- PAGE TITLE -->
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span> Buat Kartu Rencana Studi {{$prodi->nama_program_studi}}</h2>
</div>
<!-- END PAGE TITLE -->
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{route('admin.krs.store',[ 'id_tahun_ajaran' => $tahun->id,'id_semester' => $semester->id,'id_prodi' => $prodi->id_prodi])}}" method="post">
                        @csrf
...
<script>
    ...
    $(document).on('change', '#id_mahasiswa', function() {
        ...
        if (id_mahasiswa) {
            jQuery.ajax({
                url: "{{ route( 'admin.krs.mahasiswa.tingkat', '')}}" + "/" + id_mahasiswa,
                type: "GET",
                dataType: "json",

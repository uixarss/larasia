...
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span> Absensi Pegawai</h2>
</div>
<!-- END PAGE TITLE -->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        ...
                                        <form action="{{route('admin.absensi.pegawai.cari')}}" method="post">
                                            @csrf
                                    ...
                                    <div class="panel-body">
                                        <table class="table datatable">
                                            ...
                                            <tbody>
                                                @foreach($absensi_pegawai_t as $pegawai)
                                                <tr>
                                                    <td>{{$pegawai->pegawai->NIP}}</td>
                                                    <td>{{$pegawai->pegawai->nama_pegawai}}</td>
                                                    <td>{{$pegawai->pegawai->jabatan_pegawai}}</td>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <ul class="panel-controls">
                                            ...
                                            <li><a href="{{route('admin.absensi.pegawai.laporan',['tanggal_absen' => $tanggal_absen])}}"><span class="fa fa-cloud-download"></span></a></li>
                                            <li><a href="#" class="panel-fullscreen"><span class="fa fa-expand"></span></a></li>
                                        </ul>
                                    </div>

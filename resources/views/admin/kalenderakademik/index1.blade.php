      ...
      <div class="col-md-12">
        ...
        <div class="content-frame">
          ...
          <div class="content-frame-left">
              <h4>New Reminder <a href="{{url('/admin/kalenderakademik/addevent')}}" class="btn btn-default"><span class="fa fa-plus"></span> </a> </h4>
              ...
              <form class="" action="{{route('admin.kalenderakademik.store')}}" method="post">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="Tambah Reminder Disini" >
              ...
              <div class="list-group border-bottom" id="external-events">
                @foreach($kalender as $kalenders)
                  <a class="list-group-item external-event">{{$kalenders->title}}</a>
                @endforeach
              </div>
              ...
              <div class="col-md-12">
                <div id="alert_holder">
                  <div class="calender">
                    <div
                        id="calendar"
                        data-route-load-kalender="{{ route('admin.kalenderakademik.loadKalender') }}"
                    ></div>
                  </div>

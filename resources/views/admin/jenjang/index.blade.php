...
@section('content')
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#editJenjang{{ $jenjang->id }}">Edit</a>

                                <a href="{{ route('admin.jenjang.destroy', $jenjang->id) }}" class="btn btn-sm btn-danger"
                                    onclick="return confirm('Yakin Mau di Hapus ?')">Hapus</a>
                            </td>
                        </tr>
                        <!-- Modal edit jenjang-->
                        <div class="modal fade" id="editJenjang{{ $jenjang->id }}" tabindex="-1">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title">Edit Jenjangg</h3>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ route('admin.jenjang.update', $jenjang->id) }}" method="post">
                                            @csrf
                                            <div class="mb-5">
    ...
    <div class="modal fade" tabindex="-1" id="tambah">
        <div class="modal-dialog">
            <form class="modal-content" action="{{ route('admin.jenjang.create') }}" method="post">
                <div class="modal-header">

            ...
            <table id="table_data"
                ...
                <tbody class="fs-6 fw-semibold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="{{route('guru.agenda.detail', [ 'id_tahun_ajaran' => $tahun_ajaran->id ,'id_semester' => $semester->id, 'id_prodi' => $prodi->id_prodi ])}}" type="button" class="btn btn-sm btn-primary">Lihat Daftar Agenda</a>
                        </td>
                    </tr>

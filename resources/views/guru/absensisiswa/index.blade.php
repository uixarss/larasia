    ...
    <div class="card card-flush h-lg-100">
        <div class="card-header pt-7 pb-0">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Data Absensi</span>
            </h3>
            ...
            var initTable1 = function() {
                ...
                var table = $('#table_list').DataTable({
                    ...
                    ajax: function(data, callback, settings) {
                        $.ajax({
                            url: "{{ url('dosen/absensi/siswa/get_kelas') }}/"+id,
                            data: {
                    ...
                    columns: [
...

                        {
                            ...
                            render: function(data, type, full, meta) {
                               var url = "{{url('dosen/absensi/siswa/ubah_absen')}}/"+data.id;

                                return '<a class="btn btn-sm btn-warning" href="'+url+'"><i class="fa fa-pencil"></i>Ubah Status</a>';
                            },
                        },
                    ],
                });

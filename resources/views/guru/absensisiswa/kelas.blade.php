    ...
    <div class="card card-px-0 bg-opacity-0">
        <div class="card-header border-0 pb-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-2x mb-1">Pilih Kelas</span>
            </h3>
        ...
        <div class="card-body py-0">
            <table id="table_data"
                ...
                <thead class="fs-5 fw-semibold bg-light">
                    <tr>
                        <th>No</th>
                        <th>Kode Kelas/ Nama Kelas/ Tingkat</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody class="fs-6 fw-semibold text-gray-600">
                    @foreach($data_kelas as $no => $kelas)
                    <tr>
                        <td>{{++$no}}</td>
                        <td>
                            {{$kelas->kode_kelas}} /
                        ...
                        <td class="text-end">
                            <a href="{{route('guru.absensi.mahasiswa', [ 'kelas_id' => $kelas->id])}}" type="button" class="btn btn-sm btn-primary">Pilih</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>

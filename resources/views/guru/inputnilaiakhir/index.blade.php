...
<div class="page-title">
  <h2><span class="fa fa-arrow-circle-o-left"></span> Nilai Akhir</h2>
</div>
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Data Nilai Akhir</h3>
          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td align="center">
                  @can('edit-nilai')
                  <a href="{{route('guru.nilaiakhir.edit', $jadwal->kelas_id)}}" type="button" class="btn btn-success">Input Nilai</a>
                  @endcan
                </td>
              </tr>
              @endforeach

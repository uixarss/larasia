    ...
    <div class="card card-px-0 bg-opacity-0">
        <div class="card-header border-0 pb-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-2x mb-1">List Tugas</span>
            </h3>
                ...
                <tbody class="fs-6 fw-semibold text-gray-600">
                    ...
                    <tr>
                      ...
                      <td class="text-end">
                        ...
                        <a href="{{route('guru.nilaitugas.listMahasiswa',[ 'id' => $mapel_id, 'kelas' => $id_kelas, 'tugas' => $tugas->id  ])}}" type="button" class="btn btn-sm btn-primary">List Mahasiswa</a>

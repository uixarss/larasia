...
@section('content')
  ...
  <ul class="breadcrumb">
      ...
      <li><a href="{{ route('guru.banksoal.index') }}">Kumpulan Soal</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="panel-footer">
          <form action="{{route('guru.banksoal.destroy', $data_quiz->id)}}" method="post">
          {{ csrf_field() }}
          @method('delete')
            <a href="{{route('guru.banksoal.edit', $data_quiz->id)}}" type="button" class="btn btn-success pull-right">Edit Soal</a>

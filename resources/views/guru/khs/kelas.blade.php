            ...
            <table id="table_data"
                ...
                <tbody class="fs-6 fw-semibold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                        <a href="{{route('guru.pilih.mahasiswa.khs', [ 'kode_mapel' => $jadwal->mapel->kode_mapel, 'kelas_id' => $jadwal->kelas->id])}}" type="button" class="btn btn-sm btn-primary">Pilih Kelas</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>

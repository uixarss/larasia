    ...
    <div class="card card-flush h-lg-100">
        <div class="card-header pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold text-dark">Jadwal Kuliah {{$tahun_ajaran->nama_tahun_ajaran}} Semester {{$semester->nama_semester}}</span>
            </h3>
            ...
            <table class="table align-middle table-rounded border table-row-bordered table-row-gray-100 bg-white gs-5 gy-4"
                ...
                <thead>
                    <tr class="fw-bold text-muted bg-light">
                        <th class="min-w-50px rounded-start">Hari</th>
                        <th>Waktu</th>
                        <th>Mata Kuliah</th>
                        <th class="rounded-end">Dosen</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @foreach($data_jadwal_ekstensi as $jdwl)
                    <tr>
                      <td>{{$jdwl->hari->hari}}</td>
                      <td>{{$jdwl->waktu->jam_masuk}} - {{$jdwl->waktu->jam_keluar}}</td>

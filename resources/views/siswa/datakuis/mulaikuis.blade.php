                          ...
                          <div class="col-md-8">
                            <div class="panel panel-success">
                              <div class="panel-body">
                                <h4 class="text-center push-up-10">Jenis Soal</h4>
                                ...
                                <!-- @if($result_quiz == null)
                                @else
                                {{$result_quiz->nilai_akhir}}
                                @endif -->
                                <!-- <h3  class="text-center">{{$data_answer->count()}}</h3> <br><br> -->
                              </div>
                          ...
                          <div class="mb-container">
                            <div class="mb-middle">
                              ...
                              <div class="mb-content">
                                <p>Anda Yakin ingin keluar dari kuis ini?</p> <strong> Siswa waktu : <time id="info-waktu"></time> </strong>
                          ...
                          <div class="col-md-6">
                            <div class="panel panel-info">
                              <div class="panel-body">
                                ...
                                <h4 class="text-center push-up-25">Siswa Waktu</h4>
                                <h3  class="text-center"><time id="waktu-akhir"></time></h3> <br><br>
                              </div>
                            </div>
                          </div>
                          <a href="{{ route('siswa.datakuis.index') }}"> <button class="btn-lg btn-success btn-block push-up-20"> Kembali</button></a>
                        </div>
                      </div>
                    </div>

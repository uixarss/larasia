...
<ul class="breadcrumb">
    ...
    <li><a href="{{ route('pegawai.evaluasisoal.index') }}">Evaluasi Soal</a></li>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <h3 class="panel-title pull-right"> Guru : {{$quiz->user->name ?? ''}}</h3>
                        <hr>
                    ...
                    <table class="table table-hover table-striped table-bordered datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                $data_jawaban_filter = $data_jawaban->where('siswa_id', $siswa->id);
                                ...
                                @endforeach
                                <td>{{$nilai_kuis->where('siswa_id', $siswa->id)->where('quiz_id', $quiz->id)->first()->nilai_akhir ?? '0'}}</td>
                            </tr>
                            @endforeach
...
<script>
    $(function() {
        ...
        $(".baris-footer .data-jawaban").on("click", function() {
            ...
            var url = '{{route("pegawai.evaluasi.soal",[":question_id",":kelas_id"])}}';

    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="pribadi" role="tabpanel">
            <form class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework"
                action="{{ route('pegawai.nonakademik.update', $pegawai->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            @foreach ($pegawai->gajis as $gaji)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="{{ route('pegawai.nonakademik.delete.gaji', ['id' => $pegawai->id, 'id_gaji' => $gaji->id]) }}"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form
                                                    action="{{ route('pegawai.nonakademik.update.gaji', ['id' => $pegawai->id, 'id_gaji' => $gaji->id]) }}"
            ...
            <div class="modal fade" tabindex="-1" id="tambahgaji">
                <div class="modal-dialog">
                    <form class="modal-content"
                        action="{{ route('pegawai.nonakademik.tambah.gaji', ['id' => $pegawai->id]) }}" method="POST">
                        <div class="modal-header">
        ...
        <div class="tab-pane fade" id="sertifikat" role="tabpanel">
                            ...
                            @foreach ($pegawai->sertifikats as $sertifikat)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="{{ route('pegawai.nonakademik.delete.sertifikat', ['id' => $pegawai->id, 'id_sertifikat' => $sertifikat->id]) }}"
                                            class="btn btn-sm btn-danger"
                                            onclick="return confirm('Yakin Mau di Hapus ?')">Hapus</a>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form
                                                    action="{{ route('pegawai.nonakademik.update.sertifikat', ['id' => $pegawai->id, 'id_sertifikat' => $sertifikat->id]) }}"
                                                    method="post" enctype="multipart/form-data">
                                                    @csrf
            ...
            <div class="modal fade" tabindex="-1" id="tambahsertifikat">
                <div class="modal-dialog">
                    <form class="modal-content"
                        action="{{ route('pegawai.nonakademik.tambah.sertifikat', ['id' => $pegawai->id]) }}"
                        method="POST">
                        <div class="modal-header">
        ...
        <div class="tab-pane fade" id="pendidikan" role="tabpanel">
                            ...
                            @foreach ($pegawai->pendidikans as $pendidikan)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="{{ route('pegawai.nonakademik.delete.pendidikan', ['id' => $pegawai->id, 'id_pendidikan' => $pendidikan->id]) }}"
                                            class="btn btn-sm btn-danger"
                                            onclick="return confirm('Yakin Mau di Hapus ?')">Hapus</a>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form
                                                    action="{{ route('pegawai.nonakademik.update.pendidikan', ['id' => $pegawai->id, 'id_pendidikan' => $pendidikan->id]) }}"
                                                    method="post" enctype="multipart/form-data">
                                                    @csrf
            ...
            <div class="modal fade" tabindex="-1" id="tambahpendidikan">
                <div class="modal-dialog">
                    <form class="modal-content"
                        action="{{ route('pegawai.nonakademik.tambah.pendidikan', ['id' => $pegawai->id]) }}"
                        method="POST">
                        <div class="modal-header">
        ...
        <div class="tab-pane fade" id="pekerjaan" role="tabpanel">
                            ...
                            @foreach ($pegawai->pekerjaans as $pekerjaan)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="{{ route('pegawai.nonakademik.delete.pekerjaan', ['id' => $pegawai->id, 'id_pekerjaan' => $pekerjaan->id]) }}"
                                            class="btn btn-sm btn-danger"
                                            onclick="return confirm('Yakin Mau di Hapus ?')">Hapus</a>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form
                                                    action="{{ route('pegawai.nonakademik.update.pekerjaan', ['id' => $pegawai->id, 'id_pekerjaan' => $pekerjaan->id]) }}"
                                                    method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="fv-row mb-5">
            ...
            <div class="modal fade" tabindex="-1" id="tambahpekerjaan">
                <div class="modal-dialog">
                    <form class="modal-content"
                        action="{{ route('pegawai.nonakademik.tambah.pekerjaan', ['id' => $pegawai->id]) }}"
                        method="POST">
                        <div class="modal-header">
        ...
        <div class="tab-pane fade" id="mutasi" role="tabpanel">
                            ...
                            @foreach ($data_mutasi as $mutasi)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="{{ route('pegawai.nonakademik.delete.mutasi', ['id' => $pegawai->id, 'id_mutasi' => $mutasi->id]) }}"
                                            class="btn btn-sm btn-danger"
                                            onclick="return confirm('Yakin Mau di Hapus ?')">Hapus</a>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form
                                                    action="{{ route('pegawai.nonakademik.update.mutasi', ['id' => $pegawai->id, 'id_mutasi' => $mutasi->id]) }}"
                                                    method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="fv-row mb-5">
            ...
            <div class="modal fade" tabindex="-1" id="tambahmutasi">
                <div class="modal-dialog">
                    <form class="modal-content"
                        action="{{ route('pegawai.nonakademik.tambah.mutasi', ['id' => $pegawai->id]) }}" method="POST">
                        <div class="modal-header">

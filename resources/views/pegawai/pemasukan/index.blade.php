...
<ul class="breadcrumb">
    ...
    <li>Data Pemasukan</li>
</ul>
<!-- END BREADCRUMB -->

<!-- PAGE TITLE -->
<div class="page-title">
    <h3><span class="fa fa-user"></span> Data Pemasukan</h3>
</div>
<!-- END PAGE TITLE -->
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default tabs">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="active"><a href="#tab-akademik" role="tab" data-toggle="tab">Data Pemasukan</a></li>
                </ul>
                    ...
                    <div class="tab-pane active" id="tab-akademik">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                @can('create-keuangan')
                                <h3 class="panel-title"><a href="{{route('pegawai.pemasukan.create')}}" class="btn btn-success">Create New</a></h3>
                                @end
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('edit-keuangan')
                                                <a href="{{route('pegawai.pemasukan.edit',[$revenue])}}" class="btn btn-info">Edit</a>
                                                @endcan
                                            </td>

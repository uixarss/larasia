        ...
        <div class="d-flex flex-column flex-lg-row">
            ...
            <div class="flex-lg-row-fluid ms-lg-15">
                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kampus">Data
                            Kampus</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="kampus" role="tabpanel">
                        <form class="card pt-4 mb-6 mb-xl-9"
                            action="{{route('pegawai.dosen.updatedatakampus', $dosen->id)}}" method="POST">
                            @csrf
                            ...
                            <div class="card-body pt-0 pb-5">
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><span class="fa fa-pencil"></span></span>
                                        <input name="mulai_sk_pengangkatan" type="datepicker"
                                            class="form-control datepicker" value="{{ $dosen->mulai_sk_pengangkatan }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="status" class="form-control">
                                            ...
                                            <option value="0,Tidak Aktif"
                                                @if ($dosen->id_status_aktif == '0') selected @endif>
                                                Tidak Aktif
                                            </option>
                                        </select>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="pribadi" role="tabpanel">
                        <form class="card pt-4 mb-6 mb-xl-9"
                            action="{{ route('pegawai.dosen.updatedatapribadi', $dosen->id) }}" method="POST">
                            @csrf
                            <div class="card-header border-0">
                                <div class="card-title">
                                    <h2>Data Pribadi</h2>
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <div class="input-group">
                                        <select name="nama_agama" class="form-control">
                                            ...
                                            <option value="2,Kristen" @if ($dosen->id_agama == 2) selected @endif>
                                                Kristen
                                            </option>
                                            <option value="3,Katolik" @if ($dosen->id_agama == 3) selected @endif>
                                                Katolik
                                            </option>
                    ...
                    <div class="tab-pane fade" id="other" role="tabpanel">
                        <form class="card pt-4 mb-6 mb-xl-9"
                            action="{{ route('pegawai.dosen.updatelainnya', $dosen->id) }}" method="POST">
                            @csrf
                            <div class="card-header border-0">
                                <div class="card-title">
                                    <h2>Data Lainnya</h2>
                            ...
                            <div class="card-body pt-0 pb-5">
                                    ...
                                    <div class="input-group">
                                        <div class="form-check form-check-custom form-check-solid me-7">
                                            <input id="ya" class="form-check-input" type="radio"
                                                ...
                                                {{ $dosen->mampu_handle_kebutuhan_khusus == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label">Ya</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid me-7">
                                            <input id="tidak" class="form-check-input"
                                                type="radio"name="mampu_handle_kebutuhan_khusus"
                                                value="0"{{ $dosen->mampu_handle_kebutuhan_khusus == 0 ? 'checked' : '' }}>
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <div class="input-group">
                                        <div class="form-check form-check-custom form-check-solid me-7">
                                            <input id="ya" class="form-check-input" type="radio"
                                                name="mampu_handle_braille" value="1"
                                                {{ $dosen->mampu_handle_braille == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label">Ya</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid me-7">
                                            <input id="tidak" class="form-check-input"
                                                type="radio"name="mampu_handle_braille"
                                                value="0"{{ $dosen->mampu_handle_braille == 0 ? 'checked' : '' }}>
                                            <label class="form-check-label">Tidak</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <div class="input-group">
                                        <div class="form-check form-check-custom form-check-solid me-7">
                                            <input id="ya" class="form-check-input" type="radio"
                                                name="mampu_handle_bahasa_isyarat" value="1"
                                                {{ $dosen->mampu_handle_bahasa_isyarat == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label">Ya</label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid me-7">
                                            <input id="tidak" class="form-check-input"
                                                type="radio"name="mampu_handle_bahasa_isyarat"
                                                value="0"{{ $dosen->mampu_handle_bahasa_isyarat == 0 ? 'checked' : '' }}>
                                            <label class="form-check-label">Tidak</label>
                                        </div>
                                    </div>
                                </div>
    ...
    @section('data-scripts')
        <script>
            ...
            if (myInput && myInput.value) {
                ...
                if (kota[0]) {
                    jQuery.ajax({
                        url: "{{ route('pegawai.dosen.store', '') }}" + "/" + kota[0],
                        type: "GET",
                        dataType: "json",
            ...
            $(document).on('change', '#nama_kota', function() {
                ...
                if (id_kota[0]) {
                    jQuery.ajax({
                        url: "{{ route('pegawai.dosen.store', '') }}" + "/" + id_kota[0],
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
                            console.log(data);

...
@section('content')
  ...
  <ul class="breadcrumb">
      ...
      <li><a href="{{route('pegawai.kumpulansoal.listSoal', [ 'id' => $pengampu->id] )}}">Kumpulan Soal</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="panel-footer">
          <form action="{{route('pegawai.kumpulansoal.destroy', $data_quiz->id)}}" method="post">
          {{ csrf_field() }}
          @method('delete')
            <a href="{{route('pegawai.kumpulansoal.edit', $data_quiz->id)}}" type="button" class="btn btn-success pull-right">Edit Soal</a>
